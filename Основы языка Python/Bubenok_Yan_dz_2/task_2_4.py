...
list_raw = ['инженер-конструктор Игорь', 'главный бухгалтер МАРИНА', 'токарь высшего разряда нИКОЛАй', 'директор аэлита']

for item in list_raw:
    print("Привет, ", "".join((item.split())[-1:]).capitalize(), "!", sep="")
